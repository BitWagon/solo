...
import { ChevronRight, Calendar, User, Clock, ArrowUp, Menu, X } from 'lucide-react';
...
const AutoHubBlog = () => {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt: "Discover the pros and cons of electric and hybrid vehicles to make an informed decision.",
      author: "Sarah Chen",
      date: "July 5, 2025",
      readTime: "6 min read",
      category: "Technology",
    ...
    },
    {
      ...
      excerpt: "Don't ignore these warning signs that could prevent costly repairs down the road.",
    ...
    },
    {
      ...
      excerpt: "A comprehensive guide to selecting the perfect tires for performance, safety, and longevity.",
      author: "Lisa Park",
      date: "June 30, 2025",
      readTime: "7 min read",
      category: "Parts",
    ...
    },
    {
      ...
      excerpt: "Prepare your vehicle and yourself for safe winter driving with these expert recommendations.",
      author: "Tom Wilson",
      date: "June 28, 2025",
      readTime: "6 min read",
      category: "Safety",
    ...
    },
    {
      ...
      excerpt: "Navigate the complex world of auto insurance with confidence and find the best coverage.",
      author: "Emily Davis",
      date: "June 25, 2025",
      readTime: "9 min read",
      category: "Insurance",
  ...
  const categories = ["All", "Maintenance", "Technology", "Safety", "Parts", "Insurance"];
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-16 bg-gradient-to-br from-black via-gray-900 to-black">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl mb-8 text-gray-300 animate-fadeIn">
              Your trusted source for automotive insights, tips, and industry news
            </p>
            <div className="flex justify-center space-x-4 animate-slideUp">
              <div className="px-6 py-3 bg-yellow-400/10 rounded-full border border-yellow-400/30">
                <span className="text-yellow-400 font-semibold">Expert Advice</span>
              </div>
              <div className="px-6 py-3 bg-yellow-400/10 rounded-full border border-yellow-400/30">
                <span className="text-yellow-400 font-semibold">Latest Trends</span>
              </div>
              <div className="px-6 py-3 bg-yellow-400/10 rounded-full border border-yellow-400/30">
                <span className="text-yellow-400 font-semibold">Industry News</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-20 left-10 w-2 h-2 bg-yellow-400 rounded-full animate-bounce"></div>
          <div className="absolute top-40 right-20 w-3 h-3 bg-yellow-400 rounded-full animate-bounce" style={{animationDelay: '0.5s'}}></div>
          <div className="absolute bottom-20 left-1/4 w-1 h-1 bg-yellow-400 rounded-full animate-bounce" style={{animationDelay: '1s'}}></div>
        </div>
      </section>
